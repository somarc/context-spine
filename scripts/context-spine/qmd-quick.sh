...
QMD_QUERY_BOOTSTRAP="${CONTEXT_SPINE_QMD_QUERY_BOOTSTRAP:-$CONFIG_CONTEXT_SPINE_QMD_QUERY_BOOTSTRAP}"
QMD_QUERY="${CONTEXT_SPINE_QMD_QUERY:-$CONFIG_CONTEXT_SPINE_QMD_QUERY}"
QMD_QUERY_EXTRA="${CONTEXT_SPINE_QMD_QUERY_EXTRA:-$CONFIG_CONTEXT_SPINE_QMD_QUERY_EXTRA}"
QMD_QUERY_SKILLS="${CONTEXT_SPINE_QMD_QUERY_SKILLS:-$CONFIG_CONTEXT_SPINE_QMD_QUERY_SKILLS}"
QMD_COLLECTIONS="${CONTEXT_SPINE_QMD_COLLECTIONS:-$CONFIG_CONTEXT_SPINE_QMD_COLLECTIONS}"
QMD_APPEND="${CONTEXT_SPINE_QMD_APPEND:-$CONFIG_CONTEXT_SPINE_QMD_APPEND}"
QMD_RETRIES="${CONTEXT_SPINE_QMD_RETRIES:-$CONFIG_CONTEXT_SPINE_QMD_RETRIES}"
QMD_RETRY_SLEEP_SEC="${CONTEXT_SPINE_QMD_RETRY_SLEEP_SEC:-$CONFIG_CONTEXT_SPINE_QMD_RETRY_SLEEP_SEC}"
